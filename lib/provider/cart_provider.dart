...
class CartProvider extends ChangeNotifier {
  ...
  List<Product> productList = []; // List to store all products
  List<Product> filteredList = []; // List to store filtered products
  late Future<List<Product>> _searchResults;

  HttpService httpService = HttpService();
  Future<void> fetchProducts() async {
    List<Product> products = await httpService.getProductList();
